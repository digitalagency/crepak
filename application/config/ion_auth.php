 ...
 */
$config['site_title']                 = "Crepak";            // Site Title, example.com
//$config['admin_email']                = "sales@crepak.com"; // Admin Email, admin@example.com
$config['admin_email']                = "ayaz.din@gmail.com"; // Admin Email, admin@example.com
$config['admin_cc_email']             = "binaya619@gmail.com"; // Admin Email, admin@example.com
