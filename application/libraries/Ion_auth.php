...
class Ion_auth
{
	 ...
	 *
	 **/
	public function is_companyadmin($id=false)
	{
		$this->ion_auth_model->trigger_events('is_companyadmin');
		$com_admin=$this->config->item('min_admin_group','ion_auth');
		return $this->in_group($com_admin, $id);
	}
