            ...
            <div class='col-md-12'>
              <div class='box box-info'>
                ...
                <div class='box-body pad'>
                  ...
                  <form role="form" method="post" class="form-horizontal" action="<?php echo base_url('digitalauth/addpage');?>" enctype="multipart/form-data">
                    <div class="box-body">
    ...
    <script src="<?php echo base_url(); ?>scriptscss/admin/bootstraps/js/bootbox.min.js" type="text/javascript"></script>
        ...
        <script>
          function titletoslug() {
              ...
              $.ajax({
                  url:"<?php echo base_url('digitalauth/checkpage/')?>",
                  data: {title: title},
                  type: 'POST',
