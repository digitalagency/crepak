            ...
            <div class='box box-info'>
                ...
                <div class='box-header'>
                    ...
                    <div class="pull-right">
                        <a class="btn btn-primary" href="<?php echo base_url('dacadmin/category/addcategory')?>">Add Category </a>
                    </div>
                </div><!-- /.box-header -->
                <div class="box-body">
...
//                            echo '</pre>'
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo base_url('dacadmin/category/editcategory/'.$article->id); ?>" title="Edit <?php echo $article->title;?>"><span class="glyphicon glyphicon-pencil"></span></a>
                                    <a href="<?php echo base_url('dacadmin/category/deletecategory/'.$article->id); ?>" title="Delete <?php echo $article->title;?>"><span class="glyphicon glyphicon-remove"></span></a>
...
<script>
    function toggleCategoryStatus(id,stat){
        url = '<?php echo base_url();?>dacadmin/category/toggleCategoryStatus/'+id+'/' + stat;
