            ...
            <div class='box box-info'>
                ...
                <div class='box-header'>
                    ...
                    <div class="pull-right">
                        <a class="btn btn-primary" href="<?php echo base_url('dacadmin/gallery/addimage/'.$id)?>">Add Photos </a>
                    </div>
                </div><!-- /.box-header -->
                <div class="box-body">
                            ...
                            foreach($imageValues as $gallery){
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?php echo base_url('dacadmin/gallery/deleteimage/'.$gallery->id.'/'.$id); ?>"><span class="glyphicon glyphicon-remove"></span></a>
                                    </td>
                                </tr>
                            <?php }
...
<script>
    function togglePhotoStatus(id,stat,idd){
        ...
        url = '<?php echo base_url();?>dacadmin/gallery/toggleImageStatus/'+id+'/' + stat+'/'+idd;
