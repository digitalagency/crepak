            ...
            <div class='box box-info'>
                ...
                <div class='box-body pad'>
                    ...
                    <form role="form" method="post" class="form-horizontal"
                          action="<?php echo base_url('dacadmin/successstory/editstory') . '/' . $id; ?>"
                ...
                <div class="form-group">
                    <div class="col-sm-12 col-md-6 col-xs-12">
                        ...
                        <?php if (!empty($image)) { ?>
                            <div class="imageview">
                                <img class="img-responsive" src="<?php echo base_url() . 'uploads/stories/thumbnail/' . $image ?>" alt="" />
                            </div>
                    ...
                    <div class="col-sm-12 col-md-6 col-xs-12">
                        ...
                        <?php if (!empty($image_cn)) { ?>
                            <div class="imageview">
                                <img class="img-responsive" src="<?php echo base_url() . 'uploads/stories/thumbnail/' . $image_cn ?>" alt=""/>
                            </div>
                        <?php }?>
                    </div>
                </div>
...
<script>
    function titletoslug() {
        ...
        if (orgtitle != title) {
            $.ajax({
                url: "<?php echo base_url('dacadmin/successstory/checkstory/')?>",
                data: {title: title},
                type: 'POST',
