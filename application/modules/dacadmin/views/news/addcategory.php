        ...
        <div class='col-md-12'>
            <div class='box box-info'>
                ...
                <div class='box-body pad'>
                    ...
                    <form role="form" method="post" class="form-horizontal" action="<?php echo base_url('dacadmin/news/addnewscategory');?>" enctype="multipart/form-data">
                        <div class="box-body">
...
<script>
    function titletoslug() {
        ...
        $.ajax({
            url:"<?php echo base_url('dacadmin/news/checknewscategory/')?>",
            data: {title: title},
            type: 'POST',
