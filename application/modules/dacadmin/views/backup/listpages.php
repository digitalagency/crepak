            ...
            <div class='box box-info'>
                ...
                <div class='box-header'>
                    ...
                    <div class="pull-right">
                        <a class="btn btn-primary" href="<?php echo base_url('digitalauth/addpage')?>">Add Article </a>
                    </div>
                </div><!-- /.box-header -->
                <div class="box-body">
                    ...
                    <table id="tablelist" class="table table-bordered table-striped">
                        ...
                        foreach($articles as $article){?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo base_url('digitalauth/editpage/'.$article['id']); ?>"><span class="glyphicon glyphicon-pencil"></span></a>
                                    <a href="<?php echo base_url('digitalauth/deletepage/'.$article['id']); ?>"><span class="glyphicon glyphicon-remove"></span></a>
                                </td>
                            </tr>
                        <?php }
                        ?>
...
<script>
    function togglePageStatus(id,stat){
        url = '<?php echo base_url();?>digitalauth/togglePageStatus/'+id+'/' + stat;
