            ...
            <div class='box box-info'>
                ...
                <div class='box-header'>
                    ...
                    <div class="pull-right">
                        <a class="btn btn-primary" href="<?php echo base_url('dacadmin/addmenu') ?>">Add Menu </a>
                    </div>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    ...
                    <table id="tablelist" class="table table-bordered table-striped">
                        ...
                        foreach ($menus as $menu) {
                            ?>
                            <tr>
                                <td><?php echo $menu['title'] . ' (' . $menu['title_cn'] . ')' ?></td>
                                <td><?php
                                    if ($menu['parent_id'] != '0') {
                                ...
                                <td>
                                    <a href="javascript:void(0)"
                                       onclick="toggleMenuStatus(<?php echo $menu['id']; ?>,<?php echo $menu['status']; ?>)">
                                        <?php
                                        if ($menu['status'] == '1') {
                                ...
                                <td>
                                    <a href="<?php echo base_url('dacadmin/editmenu/' . $menu['id']); ?>"><span
                                            class="glyphicon glyphicon-pencil"></span></a>
                                    <a href="<?php echo base_url('dacadmin/deletemenu/' . $menu['id']); ?>"><span
...
<script>
    function toggleMenuStatus(id, stat) {
        url = '<?php echo base_url();?>dacadmin/toggleMenuStatus/' + id + '/' + stat;
