         ...
         <ul class="sidebar-menu">
           ...
           <li class="treeview <?php if ($this->uri->segment(2) == "addmenu"||$this->uri->segment(2) == "listmenus"||$this->uri->segment(2) == "editmenu") echo "active"; ?>">
             ...
             <li class="treeview <?php if ($this->uri->segment(3) == "addbanner"||$this->uri->segment(3) == "listbanners"||$this->uri->segment(3) == "editbanner") echo "active"; ?>">
                 ...
                 <ul class="treeview-menu">
                     <li class="<?php if($this->uri->segment(3)=="addbanner")echo "active"?>"><a href="<?php echo base_url('digitalauth/banner/addbanner')?>"><i class="fa fa-circle-o"></i> Add Banner</a></li>
                     <li class="<?php if($this->uri->segment(3)=="listbanners")echo "active"?>"><a href="<?php echo base_url('digitalauth/banner/listbanners')?>"><i class="fa fa-circle-o"></i> List of Banners</a></li>
                 </ul>
             </li>
