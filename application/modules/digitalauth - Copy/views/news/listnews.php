...
//                         ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo base_url('digitalauth/news/editnews/'.$news->id); ?>" title="Edit <?php echo $news->title;?>"><span class="glyphicon glyphicon-pencil"></span></a>
                                    <a href="<?php echo base_url('digitalauth/news/deletenews/'.$news->id); ?>" title="Delete <?php echo $news->title;?>"><span class="glyphicon glyphicon-remove"></span></a>
...
<script>
    function togglenewsStatus(id,stat){
        url = '<?php echo base_url();?>digitalauth/news/togglenewsStatus/'+id+'/' + stat;
