            ...
            <div class='box box-info'>
                ...
                <div class='box-header'>
                    ...
                    <div class="pull-right">
                        <a class="btn btn-primary" href="<?php echo base_url('digitalauth/banner/addbanner')?>">Add Banner </a>
                    </div>
                </div><!-- /.box-header -->
                <div class="box-body">
...
//                            echo '</pre>'
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo base_url('digitalauth/banner/editbanner/'.$article->id); ?>" title="Edit <?php echo $article->title;?>"><span class="glyphicon glyphicon-pencil"></span></a>
                                    <a href="<?php echo base_url('digitalauth/banner/deletebanner/'.$article->id); ?>" title="Delete <?php echo $article->title;?>"><span class="glyphicon glyphicon-remove"></span></a>
                                </td>
                            </tr>
                        <?php }
                        ?>
...
<script>
    function togglePageStatus(id,stat){
        url = '<?php echo base_url();?>digitalauth/pages/togglePageStatus/'+id+'/' + stat;
