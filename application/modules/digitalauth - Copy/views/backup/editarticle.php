            ...
            <div class='col-md-12'>
              <div class='box box-info'>
                ...
                <div class='box-body pad'>
                  ...
                  <form role="form" method="post" class="form-horizontal" action="<?php echo base_url('digitalauth/editarticle').'/'.$id;?>" enctype="multipart/form-data">
                    <div class="box-body">
...
<script src="<?php echo base_url(); ?>scriptscss/admin/bootstraps/js/bootbox.min.js" type="text/javascript"></script>
        <script>
          function titletoslug() {
              ...
              if(orgtitle!=title){
                  $.ajax({
                      url:"<?php echo base_url('digitalauth/checkartilce/')?>",
                      data: {title: title},
                      type: 'POST',
