            ...
            <div class='box box-info'>
                    ...
                    <div class='box-header'>
                        ...
                        <div class="pull-right">
                          <a class="btn btn-primary" href="<?php echo base_url('digitalauth/addarticle')?>">Add Article </a>
                        </div>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                            ...
                            <?php
                                foreach($articles as $article){?>
                                    <tr>
                                        ...
                                        <td>
                                          <a href="<?php echo base_url('digitalauth/editarticle/'.$article['id']); ?>"><span class="glyphicon glyphicon-pencil"></span></a>
                                          <a href="<?php echo base_url('digitalauth/deletearticle/'.$article['id']); ?>"><span class="glyphicon glyphicon-remove"></span></a>
                                        </td>
                                    </tr>
                                <?php }
                            ?>
...
<script>
    function toggleArticleStatus(id,stat){
        url = '<?php echo base_url();?>digitalauth/toggleArticleStatus/'+id+'/' + stat;
