            ...
            <div class='box box-info'>
                ...
                <div class='box-body pad'>
                    ...
                    <form role="form" method="post" class="form-horizontal"
                          action="<?php echo base_url('digitalauth/news/addnews'); ?>"
...
<script>
    function titletoslug() {
        ...
        $.ajax({
            url:"<?php echo base_url('digitalauth/news/checknews/')?>",
            data: {title: title},
            type: 'POST',
            success: function(data){
                if(data == 1){

                    bootbox.confirm("<h4>News's title Already Exist</h4>", function(result) {
                        if(result){
