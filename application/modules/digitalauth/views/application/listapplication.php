...
//
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo base_url('digitalauth/application/editapplication/' . $application->id); ?>"
                                       title="Edit <?php echo $application->title; ?>"><span
                                            class="glyphicon glyphicon-pencil"></span></a>
                                    <a href="<?php echo base_url('digitalauth/application/deleteapplication/' . $application->id); ?>"
...
<script>
    function toggleApplicationStatus(id, stat) {
        url = '<?php echo base_url();?>digitalauth/application/toggleApplicationStatus/' + id + '/' + stat;
