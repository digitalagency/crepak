...
//                            echo '</pre>'
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo base_url('digitalauth/successstory/editstory/'.$story->id); ?>" title="Edit <?php echo $story->title;?>"><span class="glyphicon glyphicon-pencil"></span></a>
                                    <a href="<?php echo base_url('digitalauth/successstory/deletestory/'.$story->id); ?>" title="Delete <?php echo $story->title;?>"><span class="glyphicon glyphicon-remove"></span></a>
                                </td>
                            </tr>
                        <?php }
                        ?>
...
<script>
    function toggleStoryStatus(id,stat){
        url = '<?php echo base_url();?>digitalauth/successstory/toggleStoryStatus/'+id+'/' + stat;
