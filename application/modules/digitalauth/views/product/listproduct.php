            ...
            <div class='box box-info'>
                ...
                <div class='box-header'>
                    ...
                    <div class="pull-right">
                        <a class="btn btn-primary" href="<?php echo base_url('digitalauth/product/addproduct') ?>">Add
                            Product </a>
                    </div>
                </div>
                <!-- /.box-header -->
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    if ($article->featured_img != '') {
                                        ?>
                                        <img
                                            src="<?php echo base_url() . 'uploads/products/thumbnail/' . $article->featured_img ?>"
                                            width="150" alt="">
                                    <?php }
                                    ?>
                                ...
                                <td>
                                    ...
                                    if ($article->featured_img_cn != '') {
                                        ?>
                                        <img
                                            src="<?php echo base_url() . 'uploads/products/thumbnail/' . $article->featured_img_cn ?>"
                                            width="150" alt="">
                                    <?php }
                                    ?>

                                    <?php //echo $article['featured_img_cn']
                                    ?></td>
                                ...
                                <td><?php
                                    ...
                                    ?></td>
                                <td>
                                    <a href="<?php echo base_url('digitalauth/gallery/listimages/' . $article->id) ?>">
                                        <img src="<?php echo base_url(); ?>scriptscss/images/gallery.png">
                                    </a>
                                </td>
                                <td>
                                    <a href="javascript:void(0)"
                                       onclick="toggleCategoryStatus(<?php echo $article->id; ?>,<?php echo $article->status; ?>)">
                                        <?php
                                        if ($article->status == '1') {
                                ...
                                <td>
                                    <a href="<?php echo base_url('digitalauth/product/editproduct/' . $article->id); ?>"
                                       title="Edit <?php echo $article->title; ?>"><span
                                            class="glyphicon glyphicon-pencil"></span></a>
                                    <a href="<?php echo base_url('digitalauth/product/deleteproduct/' . $article->id); ?>"
                                       title="Delete <?php echo $article->title; ?>"><span
