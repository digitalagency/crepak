                        ...
                        foreach($galleries as $gallery){?>
                            <tr>
                                ...
                                <td><?php  $count = $this->mymodel->getcount('*','tbl_gallery_image','gallery_id ='.$gallery['id']);
                                    ...
                                    ?></td>
                                <td><a href="<?php echo base_url('admin/listphoto/'.$gallery['id'])?>"><img src="<?php echo base_url();?>scriptscss/images/gallery.png"></a></td>
                                <td>
                                ...
                                <td>
                                    <a href="<?php echo base_url('admin/editgallery/'.$gallery['id']); ?>"><span class="glyphicon glyphicon-pencil"></span></a>
                                    <a href="<?php echo base_url('admin/deletegallery/'.$gallery['id']); ?>"><span class="glyphicon glyphicon-remove"></span></a>
                                </td>
                            </tr>
                        <?php }
                        ?>
