            ...
            <div class='box box-info'>
                ...
                <div class='box-header'>
                    ...
                    <div class="pull-right">
                        <a class="btn btn-primary" href="<?php echo base_url('admin/addmenu')?>">Add Menu </a>
                    </div>
                </div><!-- /.box-header -->
                <div class="box-body">
                    ...
                    <table id="tablelist" class="table table-bordered table-striped">
                        ...
                        foreach($menus as $menu){?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo base_url('admin/editmenu/'.$menu['id']); ?>"><span class="glyphicon glyphicon-pencil"></span></a>
                                    <a href="<?php echo base_url('admin/deletemenu/'.$menu['id']); ?>"><span class="glyphicon glyphicon-remove"></span></a>
                                </td>
                            </tr>
                        <?php }
                        ?>
...
<script>
    function toggleMenuStatus(id,stat){
        url = '<?php echo base_url();?>admin/toggleMenuStatus/'+id+'/' + stat;
